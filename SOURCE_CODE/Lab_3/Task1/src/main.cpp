...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Akib Reza", NULL, NULL);
    if (window == NULL)
    {
    ...
    // Obtuse triangle vertices (placed to the right of the square)
...
void processInput(GLFWwindow *window)
{
    ...
    // Close window when 'A' (first letter of Akib) is pressed
